...
namespace WebBanHang.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public LoaiSanPhamsController(MvcBanHangContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,tenloaisp,trangthai")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("id,tenloaisp,trangthai")] LoaiSanPham loaiSanPham)
        {
